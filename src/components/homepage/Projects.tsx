		...
		<section className="bg-primary text-text px-4">
			...
			<div className="grid justify-center flex-col md:flex-row">
				<div className="grid gap-6 justify-center items-center py-16 sm:grid-cols-2 lg:grid-cols-3">
					<div
						className="w-[19em] mx-auto rounded-xl p-6 bg-primary-light shadow-lg space-y-3 transition
				    duration-150 ease-in-out hover:bg-mirage-900 hover:ring-mirag hover:-translate-y-1"
					>
						<div className="flex justify-between items-center">
							<h1 className="text-secondary group-hover:text-text-light text-sm font-semibold">
							...
							<div className="flex">
								{/* <Link href="" className="m-5">
									<svg
										className="transition ease-in-out text-text hover:text-secondary
                  ...
                  hover:scale-110 duration-150"
						...
						<p className="text-text group-hover:text-text-light text-sm">
